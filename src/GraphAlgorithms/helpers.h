...
* The TsmResult struct contains the information about the shortest path and its length obtained from solving the
* Traveling Salesman Problem (TSP). It includes a vector of vertices representing the order in which the vertices
* should be visited to form the shortest path, and the distance representing the total length of the path.
*/
struct TsmResult {
  ...
  * @param v The vertices in the order they should be visited to form the shortest path.
  */
  ...
  * @return True if the distance of this TsmResult is less than the distance of the other TsmResult, false otherwise.
  */
